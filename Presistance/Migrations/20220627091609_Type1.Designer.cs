...
namespace Presistance.Migrations
{
    ...
    [Migration("20220627091609_Type1")]
    partial class Type1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Authentication.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2022, 6, 27, 16, 16, 6, 676, DateTimeKind.Unspecified).AddTicks(5287), new TimeSpan(0, 7, 0, 0, 0)),
            ...
            modelBuilder.Entity("Domain.MemberAdvanceLeaveRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable(" MemberAdvanceLeaveRequest", "AdvanceLeave");
                });
            ...
            modelBuilder.Entity("Domain.MemberAdvanceLeaveRequest", b =>
                {
                    b.HasOne("Domain.AdvanceLeave", "AdvanceLeave")
                        .WithOne("MemberAdvanceLeaveRequests")
                        .HasForeignKey("Domain.MemberAdvanceLeaveRequest", "AdvanceLeaveId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.HasOne("Domain.Member", "Member")
                        .WithOne("MemberAdvanceLeaveRequest")
                        .HasForeignKey("Domain.MemberAdvanceLeaveRequest", "MemberId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.AdvanceLeave", b =>
                {
                    ...
                    b.Navigation("MemberAdvanceLeaveRequests")
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Domain.Member", b =>
                {
                    ...
                    b.Navigation("MemberAdvanceLeaveRequest");

...
namespace Presistance.Migrations
{
    ...
    [Migration("20220625022843_Update")]
            ...
            modelBuilder.Entity("Domain.Authentication.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2022, 6, 25, 9, 28, 41, 927, DateTimeKind.Unspecified).AddTicks(8911), new TimeSpan(0, 7, 0, 0, 0)),
            ...
            modelBuilder.Entity("Domain.Member", b =>
                {
                    ...
                    b.HasOne("Domain.Authentication.User", "User")
                        .WithOne("Member")
                        .HasForeignKey("Domain.Member", "UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

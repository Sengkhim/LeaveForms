...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Authentication.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2022, 6, 27, 15, 47, 9, 94, DateTimeKind.Unspecified).AddTicks(6112), new TimeSpan(0, 7, 0, 0, 0)),
            ...
            modelBuilder.Entity("Domain.MemberAdvanceLeaveRequest", b =>
                {
                    b.HasOne("Domain.AdvanceLeave", "AdvanceLeave")
                        .WithMany("MemberAdvanceLeaveRequest")
                        .HasForeignKey("AdvanceLeaveId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
